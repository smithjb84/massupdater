...
Namespace massupater
    <ProgIdAttribute("massupater.StandardAddInServer"), _
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            Try
                ...
                m_sampleButton = Utilities.CreateButtonDefinition("Mass" & vbCr & "Updater", "smithjb84massupdater", "", "ButtonResources\SampleButton")
            ...
            Catch ex As Exception
                MsgBox("Unexpected failure in the activation of the add-in ""massupater""" & vbCrLf & vbCrLf & ex.Message)
            End Try
        End Sub
...
#Region "User interface definition"
        ...
        Private Sub AddToUserInterface()
            ...
            ' Get the "manage" tab. then update panel
            Dim manageTab As RibbonTab = drawingRibbon.RibbonTabs.Item("id_TabManage")
            Dim oPanel As RibbonPanel = manageTab.RibbonPanels.Item("id_PanelP_ToolsUpdate")
            ' Add a button.
...
Public Module Globals
    ...
    Public Const g_simpleAddInClientID As String = "8a6e9408-b3de-42ad-809c-012ddea5d5b1"
